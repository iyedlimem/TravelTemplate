...
import backImg from '../components/BackgroundImg.jpg'
  ...
  return (
    <div>
        ...
        <div className="container py-5">
          <div className="row justify-content-center py-5">
            <div className="col-lg-10 pt-lg-5 mt-lg-5 text-center">
              ...
              Experience the Perfect Safaris
              </h1>
              ...
              <div className="ratio ratio-16x9 mx-auto mt-4 mb-4   animated slideInDown">
                <iframe
                  src="https://www.youtube.com/embed/TTXsXMBkDEM?autoplay=1&mute=1"
                  title="Promo Video"
                  allowFullScreen
                ></iframe>
              </div>
          ...
          <div className="row g-5">
            ...
            <div className="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
              ...
              <div className="row gy-2 gx-4 mb-4">
                ...
                <div className="col-sm-6">
                  <p className="mb-0">
                    <i className="fa fa-star text-primary me-2" />5 Star
                    Accommodations
                  </p>
                </div>
                <div className="col-sm-6">
     ...
     backgroundPosition: 'center',
      ...
      {/* Destination Start */}
      {/* Package Start */}
      <div style={{ backgroundColor: "#5e7c1d27" }}>
        <div className="container-xxl py-5">
          <div className="container text-center">
            <div className="text-center wow fadeInUp" data-wow-delay="0.1s">
              <h6 className="section-title  text-center text-primary px-3" style={{ backgroundColor: "#e8ecdc" }}>
                Tours
              </h6>
              ...
              <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div className="package-item">
                  ...
                  <div className="d-flex border-bottom">
                    ...
                    <small className="flex-fill text-center border-end py-2">
                      <i className="fa fa-calendar-alt text-primary me-2" />5 Nights
                    </small>
                    <small className="flex-fill text-center py-2">
                      <i className="fa fa-user text-primary me-2" />2-5 Persons
                    </small>
                  </div>
            ...
            <div className="position-relative w-75 mt-5 mx-auto animated slideInDown">

              <button
                type="button"
                className="btn   py-2 px-4 "
                style={{ marginTop: 7 , color:"#446400", borderBottom: "2px solid #446400",borderRadius: "0"}}
              >
                <Link to="/packages" >
                Discover More
                </Link>
